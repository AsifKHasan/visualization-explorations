...
class EventIntermediateCatchError(EventIntermediate):
    ...
    def get_inside_element(self):
        svg_group, group_width, group_height = a_lightning_inside_a_circular_shape(radius=self.theme['inner-circle']['radius'], inner_shape_spec=self.theme['inner-shape'])
