...
class EventEndSignal(EventEnd):
    ...
    def __init__(self, bpmn_id, lane_id, pool_id, node_id, node_data):
        ...
        self.theme.update(self.current_theme['events']['ends']['EventEndSignal'])

    def get_inside_element(self):
        svg_group, group_width, group_height = an_equilateral_triangle_inside_a_circular_shape(radius=self.theme['circle']['radius'], inner_shape_spec=self.theme['inner-shape'])
