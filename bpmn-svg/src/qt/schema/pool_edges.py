...
class PoolEdges(CollapsibleFrame):
    def __init__(self, bpmn_data, bpmn_id, lane_id, pool_id, edges, parent=None):
        super().__init__(icon='edges', text='Pool Edges', parent=parent)
        self.bpmn_data, self.bpmn_id, self.lane_id, self.pool_id, self.edges = bpmn_data, bpmn_id, lane_id, pool_id, edges
