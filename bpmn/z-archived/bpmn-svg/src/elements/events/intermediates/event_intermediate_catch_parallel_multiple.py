...
class EventIntermediateCatchParallelMultiple(EventIntermediate):
    ...
    def __init__(self, current_theme, bpmn_id, lane_id, pool_id, node_id, node_data):
        ...
        self.theme.update(self.current_theme['events']['intermediates']['EventIntermediateCatchParallelMultiple'])
